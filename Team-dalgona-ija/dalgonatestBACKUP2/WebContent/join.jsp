...
<html>
	...
	<body>
		...
		<form name="info" action="<%= request.getContextPath() %>/member/join.do" method="post" enctype="multipart/form-data" onclick="return FormCheck()">
			<div class="section">
								...
								<div>
									<center>
										...
										<div>
											...
											<div>
												<input type="text" name="User_Addin" id="sample6_detailAddress" placeholder="상세주소"style="height:30px; width:60%; margin-top:25px; font-size:20pxfont-size:20px">
											</div>
											<div>
							...
							<label for="slide02" class="left" ></label>
								<div>
									<center>
										...
										<div>
											<input type="text" name="User_lib" placeholder="자격증2" style="width:80%; height:50px; font-size:20px;margin-top:25px">
										</div>
										<div>
