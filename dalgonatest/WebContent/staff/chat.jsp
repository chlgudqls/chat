...
<html>
	...
	<div style="width:350px; height:600px;">
		<div style="width:100%;height:50px; display:flex">
			<a href="#" class="btn-open-popup"><img id="hamburg" style="width:50%; margin-top:10%" src="image/more.png"></a>
		...
		<%
			...
			{
			%>
				<div id="chatbang" style="width:80%; height:100px;margin-top:20px; cursor: pointer;" onclick="location.href='<%=request.getContextPath() %>/chat/View.do'">
					<%=rv.getROOM_TITLE() %>				
				</div>
			<%
			}
